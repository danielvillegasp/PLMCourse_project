...
Geometric variables, were calculated by the team that collected the data [reference], then, since raw and
...
```{r}
inValidation <- createDataPartition(wldf$classe, p = 0.4,list=F)
